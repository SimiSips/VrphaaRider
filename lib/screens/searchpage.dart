...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if(Provider.of<AppData>(context).pickupAddress.placeName == null){
      print('Place name is null');
      pickupController.text = "No location found";
    } else {
        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: Padding(
                padding: EdgeInsets.only(left: 24, top: 48, right: 24, bottom: 5),
                child: Column(
                  children: <Widget>[
