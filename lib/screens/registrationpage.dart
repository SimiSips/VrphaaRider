...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  var homeAddController = TextEditingController();

  var workAddController = TextEditingController();
  ...
  void registerUser() async {
    ...
    if(user != null){
      ...
      Map userMap = {
        ...
        'homeadd': homeAddController.text,
        'workadd': workAddController.text,
      };

      newUserRef.set(userMap);

      //Take the user to the mainPage
      Navigator.pushNamedAndRemoveUntil(context, LoginPhone.id, (route) => false);
            ...
            child: Column(
              children: <Widget>[
                ...
                FlatButton(
                    ...
                    child: Text('Already have an account? Log in.', style: TextStyle(fontFamily: 'Brand-Bold')),
                ),
